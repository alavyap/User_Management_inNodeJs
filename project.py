...
# below is for importing stylesheet into your project
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        # this code below is for stylesheet if you want to make your window colorful
        # self.setStyleSheet(main_style_sheet)


    def save_existing_book(self, ui):
        book = {                                                        #change names according to your names
            'id': int(ui.id_spin_box.text()),
    ...
    def edit_book(self, table):
        ...
        if selected_row != -1:
            ...
            # Creating the dialog  change names according to your names
            dialog = Edit_Dialog()
            dialog.ui.id_spin_box.setValue(int(book.id))
            ...
            dialog.ui.id_input_8.setText(book.isbn)
    ...
    def save_new_book(self, ui):
        # print(ui.id_spinbox.text())  you need to change according to your names
